...
contract CryptoTrendsFund is Context, IERC20, IERC20Metadata, Ownable{
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "CTF: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "CTF: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "CTF: transfer from the zero address");
        require(recipient != address(0), "CTF: transfer to the zero address");
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "CTF: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "CTF: burn amount exceeds balance");
        unchecked {
