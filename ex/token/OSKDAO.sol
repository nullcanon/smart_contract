...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x60A27abA0503EA6ecFf786c6b4Cc6BbB8B04C23A);
    string private _name = "OSK COIN DAO";
    string private _symbol = "OSKDAO";
    ...
    constructor (){
        ...
        holderRewardCondition = 10 ** IERC20(_usdt).decimals();
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundamount1 = fundAmount / 3;
        USDT.transferFrom(address(_tokenDistributor), _usdtPair, fundamount1);
