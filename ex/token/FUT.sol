...
// 有交易开关
// 有白名单
// 手续费实时卖出自动加流动性，同时权限打到黑洞
// 如果转账金额超过自己地址的99%，那么只能转99%出来

// 买卖、转账手续费根据价格梯度决定
// 价格越高，手续费越少，初始是 12%，价格每增加2倍左右，手续费减少 2%，最少减到买1%，卖2%，转账2%
...
contract FUTToken is IERC20, Ownable {
    ...
    string private _name = "FUT";
    string private _symbol = "FUT";
    uint8 private _decimals = 18;

    uint256 private _tTotal = 9999 * 10 ** _decimals;
