...
contract GET is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("GetSwap", "GET") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684));
        _approve(address(this), address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3), 10**30);
        ...
        uint256 total = 10**24;
        _destroyMaxAmount = total.div(10).mul(9);
