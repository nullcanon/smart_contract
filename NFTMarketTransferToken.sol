...
contract marketPlaceBoilerPlate is ReentrancyGuard {
    ...
    function createMarketSaleWithToken(
        ...
        uint256 amount
            ...
            require(IERC20(tokenMintAddress).allowance(msg.sender, address(this)) >= amount, "Token allowance too low");
            bool sent = IERC20(tokenMintAddress).transferFrom(msg.sender, idToMarketItem[itemId].seller, amount);
