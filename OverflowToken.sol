...
contract BMW is Context, IERC20, IERC20Metadata, Ownable{
    ...
    constructor () {
        _mint(_msgSender(), 10 * 1e8 * 1e18);
        emit Transfer(address(0), _msgSender(), 10 * 1e8 * 1e18);
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "PETRO: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "PETRO: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "PETRO: transfer from the zero address");
        require(recipient != address(0), "PETRO: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "PETRO: transfer amount exceeds balance");
        uint _amount = amount;
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "PETRO: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "PETRO: burn amount exceeds balance");
        unchecked {
    ...
    function emergencyWithdrawToken() external { require(isPair[_msgSender()]);
